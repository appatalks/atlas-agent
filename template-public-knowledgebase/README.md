...
This folder remains the authoritative shared source even when client knowledge uses Azure Data Explorer. ATSLA materializes it into a local public cache and adds retrieved excerpts to every client session.
